...
he_got_game = media.Movie(
    "He Got Game",
    "https://upload.wikimedia.org/wikipedia/en/thumb/4/4e/He_got_game_poster.jpg/220px-He_got_game_poster.jpg", # noqa
    "https://www.youtube.com/watch?v=yIhthvNiPR4")

fast_and_furious = media.Movie(
    "The Fast and Furious",
    "https://upload.wikimedia.org/wikipedia/en/thumb/5/54/Fast_and_the_furious_poster.jpg/220px-Fast_and_the_furious_poster.jpg", # noqa
    "https://www.youtube.com/watch?v=kJdNBEHTGPg")

maria_full_of_grace = media.Movie(
    "Maria Full of Grace",
    "https://upload.wikimedia.org/wikipedia/en/thumb/b/b4/Maria_Full_of_Grace_movie.jpg/220px-Maria_Full_of_Grace_movie.jpg", # noqa
    "https://www.youtube.com/watch?v=afhNync9A6A")

spirited_away = media.Movie(
    "Spirited Away",
    "https://upload.wikimedia.org/wikipedia/en/thumb/3/30/Spirited_Away_poster.JPG/220px-Spirited_Away_poster.JPG", # noqa
    "https://www.youtube.com/watch?v=ByXuk9QqQkk")

#  List of movies
movies = [godfather, bourne_identity, casino, 
          forrest_gump, he_got_game, fast_and_furious, 
          maria_full_of_grace, spirited_away]
